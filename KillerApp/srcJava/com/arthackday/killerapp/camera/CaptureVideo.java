...
public class CaptureVideo extends Activity {
	...
	protected void onResume() {
		...
		new AsyncTask<Void, Void, Camera>() {
			...
			protected void onPostExecute(Camera camera) {
				if (camera == null) {
					Toast.makeText(CaptureVideo.this, R.string.cannot_record,
							Toast.LENGTH_SHORT);
				} else {
					CaptureVideo.this.initCamera(camera);
				}
			}
		}.execute();
	}
	...
	void initCamera(Camera camera) {
		...
		this.cameraPreview = new CameraPreview(CaptureVideo.this, this.camera);
