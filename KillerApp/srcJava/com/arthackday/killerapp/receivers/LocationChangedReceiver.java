	...
	public void onReceive(Context context, Intent intent) {
		...
		if (intent.hasExtra(locationKey)) {
			...
			Intent updateServiceIntent = new Intent(context,
					KillerService.class);
			updateServiceIntent.putExtra(KillerConstants.EXTRA_KEY_LOCATION,
					location);
			updateServiceIntent.putExtra(KillerConstants.EXTRA_KEY_RADIUS,
					KillerConstants.DEFAULT_RADIUS);
			updateServiceIntent.putExtra(
					KillerConstants.EXTRA_KEY_FORCEREFRESH, true);
