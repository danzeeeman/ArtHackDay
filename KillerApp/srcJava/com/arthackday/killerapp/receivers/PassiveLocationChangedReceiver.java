...
import com.arthackday.killerapp.gps.LegacyLastLocationFinder;
import com.arthackday.killerapp.service.KillerService;
...
public class PassiveLocationChangedReceiver extends BroadcastReceiver {
  ...
  public void onReceive(Context context, Intent intent) {
    ...
    if (intent.hasExtra(key)) {
      ...
      location = lastLocationFinder.getLastBestLocation(KillerConstants.MAX_DISTANCE, System.currentTimeMillis()-KillerConstants.MAX_TIME);
      ...
      long lastTime = prefs.getLong(KillerConstants.SP_KEY_LAST_LIST_UPDATE_TIME, Long.MIN_VALUE);
      long lastLat = prefs.getLong(KillerConstants.SP_KEY_LAST_LIST_UPDATE_LAT, Long.MIN_VALUE);
      long lastLng = prefs.getLong(KillerConstants.SP_KEY_LAST_LIST_UPDATE_LNG, Long.MIN_VALUE);
      Location lastLocation = new Location(KillerConstants.CONSTRUCTED_LOCATION_PROVIDER);
    ...
    if (location != null) {
      ...
      Intent updateServiceIntent = new Intent(context, KillerService.class);
      updateServiceIntent.putExtra(KillerConstants.EXTRA_KEY_LOCATION, location);
      updateServiceIntent.putExtra(KillerConstants.EXTRA_KEY_RADIUS, KillerConstants.DEFAULT_RADIUS);
      updateServiceIntent.putExtra(KillerConstants.EXTRA_KEY_FORCEREFRESH, false);
